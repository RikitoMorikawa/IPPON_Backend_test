import { 
  ...
  import { 
    ERROR_MESSAGES,
    SUCCESS_MESSAGES 
  } from '@src/responses/constants/reports/reportConstant';
  ...
  export const ReportErrors = {
    ...
    reportNotFound: (details?: any) => 
      new NotFoundError(ERROR_MESSAGES.REPORT_NOT_FOUND, details),
      
    invalidLimit: (details?: any) => 
      new BadRequestError(ERROR_MESSAGES.INVALID_LIMIT, details),
    ...
    invalidToken: (details?: any) => 
      new BadRequestError(ERROR_MESSAGES.INVALID_TOKEN, details)
  };
