...
export const apiBadRequestErrorResponseSchema = z.object({
...
// 404: Not Found Error
export const apiNotFoundErrorResponseSchema = z.object({
...
// 500: Server Error
export const apiServerErrorResponseSchema = z.object({
